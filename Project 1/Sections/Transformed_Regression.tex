\section{Transformed Regression: Sqrt, Log1p, Box-Cox}\label{Transformed Regression}
...
\label{tab:Auto_MPG_(Validation)_Transformed}
\begin{tabular}{|c|c|c|c|} \hline 
Metric & sqrt & log1p & box-cox($\lambda$=0.19) \\ \hline \hline 
...
\input{statsmodels/df_sqrt_autoMPG}
\end{table}
...
\input{statsmodels/df_log1p_autoMPG}
\end{table}
...
\input{statsmodels/df_boxcox_autoMPG}
\end{table}
...
\input{statsmodels/df_sqrt_housePrice}
\end{table}
...
\input{statsmodels/df_log1p_housePrice}
\end{table}
...
\input{statsmodels/df_boxcox_housePrice}
\end{table}
...
\input{statsmodels/df_sqrt_medicalCost}
\end{table}
...
\input{statsmodels/df_log1p_medicalCost}
\end{table}
...
\input{statsmodels/df_boxcox_medicalCost}
\end{table}