...
The report will be organized as follows, \Cref{Linear Regression} will be focused on linear regression, \Cref{Regularized Regression} regularized regression, \Cref{Transformed Regression} transformed regression, and \Cref{Comp_mods} will be comparing all of the models.
