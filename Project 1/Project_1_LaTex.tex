...
The report will be organized as follows, \Cref{Linear Regression} will be focused on linear regression, \Cref{Ridge Regression} ridge regression, \Cref{Lasso} lasso, \Cref{Transformed Regression} transformed regression, and \Cref{Comp_mods} will be comparing all of the models.

In \Cref{Linear Regression}, in-sample, out-of-sample, 5-fold cross validation, and feature selection results are given for multiple linear regression on all three data sets. The results come from both scalation in scala and statsmodels in python. 

\input{Sections/Linear_Regression}

\input{Sections/Ridge_Regression}

\input{Sections/Lasso_Regression}
